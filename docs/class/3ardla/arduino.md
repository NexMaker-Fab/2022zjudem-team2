...
<h1 style="font-size:1vw"><span style="color:dark bleu">Classic Family</span></h1>
...
<div class="col-md-4 col-sm-6">
                    <div class="arduino">
                        <div class="pic">
                            ...
                            <ul class="social">
                                <li><a href="hhttps://store.arduino.cc/products/arduino-leonardo-with-headers" class="fab fa-facebook">Arduino Leonardo</a></li>
                            </ul>
                        </div>
                        <div class="team-content">
                            <h3 class="title"></h3>
